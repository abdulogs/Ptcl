...
if (isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST") {
   ...
   if($update) {
    ...
    app::redirect("admin/compliants.php");  
   } 
}
?>
            ...
            <div class="card-body">
              <div class="form-row">
                ...
                <div class="form-group col-sm-12 mb-2">
                  ...
                  <textarea class="form-control font-12 shadow-none border" id="message" name="message" rows="6" disabled><?php echo $data['message']; ?></textarea>
                </div>
                <div class="form-group col-sm-12 mb-2">
                  <label class="font-weight-bolder mb-0" for="reply">Reply</label>
                  <textarea class="form-control font-12 shadow-none border" id="reply" name="reply" rows="6"><?php echo $data['reply']; ?></textarea>
                </div>
              </div>
            </div>
