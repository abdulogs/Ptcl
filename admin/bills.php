    ...
    <div class="container-fluid">
      ...
      <div class="card shadow p-0 bg-white">
        <div class="d-flex align-items-center px-3 py-2">
          ...
          <a class="btn btn-success btn-sm font-12 rounded ml-auto" href="bill-create.php">
        ...
        <table class="table table-card table-sm mb-0">
          ...
          <tbody class="font-12">
            ...
            <?php else:?>
            <tr>
              <td colspan="<?php echo $colspan; ?>" class="text-center"><b>No records found</b></td>
            </tr>
            <?php endif;?>
          </tbody>
          <tfoot>
