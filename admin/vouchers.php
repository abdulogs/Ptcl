    ...
    <div class="container-fluid">
      ...
      <div class="card shadow p-0 bg-white">
            <div class="d-flex align-items-center px-3 py-2">
              ...
              <a class="btn btn-success btn-sm font-12 rounded ml-auto" href="voucher-create.php" >
                  ...
                  <?php foreach($listing as $data):?>
                    <tr>
                        ...
                        <td class="align-middle px-3" data-label="Controls">
                            ...
                            <a href="vouchers.php?id=<?php echo $data["id"]; ?>" class="fa fa-trash text-danger"></a>
                        </td>
                    </tr>
                  <?php endforeach;?>
                <?php else:?>
