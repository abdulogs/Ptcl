...
if (isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST") {
   ...
   if($update) {
    ...
    app::redirect("admin/profile.php");  
   } 
}
?>
...
<head>
  ...
  <title><?php echo $data['first_name']." ".$data['last_name']; ?></title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb bg-transparent">
        ...
        <li class="breadcrumb-item active"><?php echo $data['first_name']." ".$data['last_name']; ?></li>
      </ol>
          ...
          <div class="card shadow mb-5 mt-5">
            <div class="card-header bg-white text-center px-3">
              <h5 class="card-title m-0">
                <b><span class="fa fa-edit mr-2 text-success"></span> Update profile</b>
              </h5>
            </div>
            <div class="card-body">
              <div class="form-row">
            ...
            <div class="card-footer bg-white text-center px-3">
              <button class="btn btn-success btn-sm px-5" type="submit"><b>Update</b></button>
            </div>
          </div>
        </form>
      </div>
